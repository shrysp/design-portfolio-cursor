            ...
            >
              {project.images.slice(1).map((image, index) => (
                <div
                  ...
                  className={`md:w-20 md:h-20 w-12 h-12 rounded-lg bg-slate-100 overflow-hidden cursor-pointer transition-[opacity,box-shadow,border-color] duration-200 ${
