    ...
    <Link href={link} className="isolate group w-full flex flex-col gap-4 cursor-pointer relative active:scale-[0.98] md:active:scale-100 transition-transform duration-100">
      ...
      <div className="w-full flex justify-between items-center">
        ...
        >
          ...
          <ArrowRight className="rotate-0 md:-rotate-45 md:group-hover:rotate-0 transition-all duration-200" size={16} weight="bold" />
        </Button>
      </div>
      ...
      <div className="absolute -inset-2 md:-inset-4 scale-100 bg-stone-200 md:scale-97 md:bg-transparent transition-all duration-200 md:group-hover:scale-100 md:group-hover:bg-stone-200 md:group-active:scale-y-99 md:group-active:scale-x-[0.99] md:rounded-3xl rounded-t-xl rounded-b-3xl  -z-10"></div>
    </Link>
  );
}
