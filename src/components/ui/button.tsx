    ...
    return (
      ...
      >
        ...
        {showHighlight && variant === "back" && (
          <div className="absolute bg-gradient-to-b from-white/90 to-white/5 rounded-b-[4px] rounded-t-[12px] group-hover:from-stone-100/70 group-hover:to-stone-100/20 inset-x-[3px] top-0.5 h-1/2" />
        )}
        {showHighlight && variant === "iconPrimary" && (
          <div className="absolute bg-gradient-to-b from-white/90 to-white/5 rounded-b-[4px] rounded-t-[12px] group-hover:from-gray-100/70 group-hover:to-gray-100/20 inset-x-[3px] top-0.5 h-1/2" />
        )}
      </button>
    );
  }
