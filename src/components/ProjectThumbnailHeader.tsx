  ...
  return (
    <Link href={link} className="isolate group w-full flex justify-between items-center cursor-pointer relative">
      ...
      >
        ...
        <ArrowRight className="-rotate-45 group-hover:rotate-0 transition-transform duration-200" size={16} weight="bold" />
      </Button>
      <div className="absolute -inset-2 scale-97 transition-[transform,background-color] duration-200 group-hover:scale-100 group-hover:bg-stone-200 group-active:scale-y-95 group-active:scale-x-[0.995] rounded-xl -z-10"></div>
    </Link>
  );
}
